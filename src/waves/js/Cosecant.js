...
* Last Updated: 1/9/21
*
* The Cosecant component receives prop values from the Wave component and keeps
* track of time through the Date.now() function. The Cosecant component graphs
* the csc() function using <circle> HTML elements.
*/
class Cosecant extends PureComponent 
{
  ...
  /**
  * Renders the current iteration of the cosecant graph.
  */
  render()
  {
 ...
 /**
  * Calculates the radius, cx, and cy for each circle in the cosecant graph for the
  ...
  */
  circleBuilder = (dataPoints) =>
  {
    ...
    for (var i = 1; i <= dataPoints; i++)
    {
      ...
      var cy = (csc((startPoint + (i * this.state.freqMultiplier)) /
